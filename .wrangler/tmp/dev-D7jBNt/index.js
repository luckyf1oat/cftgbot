...
// .wrangler/tmp/bundle-ZSbdoD/checked-fetch.js
...
// .wrangler/tmp/bundle-ZSbdoD/strip-cf-connecting-ip-header.js
...
function getVerifyPage(siteKey, botName, botId, chatId, userId, secret, status, errorMsg, currentPath) {
  ...
  var html = '<!DOCTYPE html><html lang="zh-CN"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="theme-color" content="#f4f6f8"><title>\u5B89\u5168\u9A8C\u8BC1</title><style>*{margin:0;padding:0;box-sizing:border-box}html,body{height:100%}body{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC","Microsoft YaHei",sans-serif;background:#f4f6f8;color:#17212b;display:flex;align-items:center;justify-content:center;min-height:100vh;padding:24px 16px;-webkit-font-smoothing:antialiased}.card{background:#fff;border:1px solid #e2e7ec;border-radius:8px;box-shadow:0 8px 28px rgba(23,33,43,.07);padding:36px 32px 30px;width:100%;max-width:390px;text-align:center}.card .shield{width:48px;height:48px;background:#eaf6fc;border:1px solid #d4ecf8;border-radius:8px;display:flex;align-items:center;justify-content:center;margin:0 auto 18px;padding:11px}.card .shield svg{width:100%;height:100%;fill:none;stroke:#168acd;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.card h1{font-size:21px;font-weight:650;color:#17212b;margin-bottom:8px;letter-spacing:0}.card .sub{font-size:14px;color:#697782;margin-bottom:16px;line-height:1.6}.card .bot-tag{display:inline-block;max-width:100%;padding:5px 10px;background:#f4f6f8;border:1px solid #e5e9ed;border-radius:6px;font-size:12px;color:#53616d;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;margin-bottom:24px}#verify-form{border-top:1px solid #edf0f2;padding-top:24px}.turnstile-wrap{display:flex;justify-content:center;min-height:65px;margin-bottom:12px;overflow:hidden}.turnstile-wrap iframe{margin:0 auto}.result{border-top:1px solid #edf0f2;padding:24px 0 4px}.result .icon{width:48px;height:48px;margin:0 auto 14px}.result .icon svg{width:100%;height:100%}.result h2{font-size:18px;font-weight:650;margin-bottom:7px;color:#17212b}.result p{font-size:14px;color:#697782;line-height:1.6;margin:0 auto 8px;max-width:280px}.result.success h2{color:#168447}.result.error h2{color:#c93636}.close-hint{font-size:12px;color:#9aa5ad}.verify-btn{background:#168acd;color:#fff;border:1px solid #168acd;height:44px;padding:0 20px;border-radius:7px;font-size:14px;font-weight:600;cursor:pointer;transition:background .15s,border-color .15s,box-shadow .15s;width:100%;letter-spacing:0}.verify-btn:hover:not(:disabled){background:#087bbb;border-color:#087bbb;box-shadow:0 3px 10px rgba(22,138,205,.18)}.verify-btn:active:not(:disabled){background:#076fa8}.verify-btn:focus-visible,.retry-btn:focus-visible{outline:3px solid rgba(22,138,205,.22);outline-offset:2px}.verify-btn:disabled{color:#8c98a1;background:#eef1f3;border-color:#e1e6e9;cursor:not-allowed}.retry-btn{display:inline-flex;align-items:center;justify-content:center;height:40px;margin-top:14px;padding:0 24px;background:#168acd;color:#fff;border-radius:7px;text-decoration:none;font-size:14px;font-weight:600;transition:background .15s,box-shadow .15s}.retry-btn:hover{background:#087bbb;box-shadow:0 3px 10px rgba(22,138,205,.18)}@media(max-width:380px){body{padding:12px}.card{padding:28px 16px 24px}.turnstile-wrap{width:100%;justify-content:flex-start}#turnstile-widget{transform:scale(.9);transform-origin:top left}}@media(prefers-reduced-motion:reduce){*{transition:none!important}}</style></head><body><div class="card"><div class="shield"><svg viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div><h1>\u4EBA\u673A\u9A8C\u8BC1</h1><p class="sub">\u8BF7\u5B8C\u6210\u4E0B\u65B9\u9A8C\u8BC1\u4EE5\u8BC1\u660E\u4F60\u4E0D\u662F\u673A\u5668\u4EBA</p><div class="bot-tag">' + escHtml(botName || "\u9A8C\u8BC1") + "</div>" + contentHtml + "</div>" + extraScript + "</body></html>";
  return html;
}
...
// .wrangler/tmp/bundle-ZSbdoD/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ZSbdoD/middleware-loader.entry.ts
